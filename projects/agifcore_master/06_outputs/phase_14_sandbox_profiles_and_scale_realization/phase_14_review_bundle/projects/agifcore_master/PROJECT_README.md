...
- `00_admin/TASK_CARD_TEMPLATE.md`
- `00_admin/TOOL_PERMISSION_MATRIX.md`
- `00_admin/BRANCH_AND_WORKTREE_POLICY.md`
- `00_admin/ESCALATION_AND_FREEZE_RULES.md`

## Work Start Rule

No work starts until those files are read and the active task card exists.
...
4. audit, governor verification, and validation records exist
5. the governor asks for review using the validation-agent package
...
- every serious task runs on its own governed branch or worktree
- tool access follows the frozen tool-permission matrix
