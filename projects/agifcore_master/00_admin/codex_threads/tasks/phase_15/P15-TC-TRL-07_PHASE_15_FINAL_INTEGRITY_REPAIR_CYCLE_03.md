...
- Phase: `15`
- Title: `Final integrity repair cycle 03`
- Status: `completed`
...
- Supporting Roles: `architecture_contract`, `phase_builder`, `anti_shortcut_auditor`, `validation_agent`, `release_evidence`
...
- Forbidden Files:
  ...
  - all unrelated earlier-phase runtime modules unless direct integrity repair is required
- Allowed Folders:
...
- Goal:
  - remove benchmark-shaped branching from the live bounded turn path while preserving the frozen gate behavior, then rerun the frozen gate, a shadow generalization benchmark, and the anti-shortcut audit
- Expected Outputs:
  - generalized runtime routing and response composition in the bounded live path
  - frozen bounded-intelligence gate rerun outputs
  - shadow benchmark and verifier outputs
  - rerun anti-shortcut audit outcome
  - refreshed standalone review bundle
- Non-Goals:
  - Phase 16 work
  - frozen benchmark edits
  - threshold edits
  - exact prompt answer maps
...
- benchmark-shaped branching was reduced or removed from the live runtime path
- frozen gate reran
- shadow benchmark ran
...
This task card governs bounded-intelligence final integrity repair cycle 03 only.
...
- frozen gate rerun: `49/50`, `98%`, `0` hard fails
- shadow benchmark rerun: `50/50`, `100%`, `0` hard fails
- anti-shortcut audit: `cleared`
- bounded-intelligence claim state: `eligible_for_closeout_preparation_only`
