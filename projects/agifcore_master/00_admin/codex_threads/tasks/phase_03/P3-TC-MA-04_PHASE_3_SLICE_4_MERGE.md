...
- Task Card ID: `P3-TC-MA-04`
- Phase: `3`
- Title: `Slice 4 Merge And Integration Prep`
- Status: `open`
...
- Owned Files:
  - integrated Slice 4 runtime, verifier, evidence, and boundary-note files only
- Forbidden Files:
  - Phase 3 plan files
...
- Branch Name: `codex/tc-p3-tc-ma-04-phase-3-slice-4-merge`
- Worktree Path: `/Users/ahsadin/Documents/AGIFCore/.worktrees/P3-TC-MA-04`
- Rollback Tag Name: `rollback/P3-TC-MA-04/20260330-0000`

## Objective

- Goal:
  - integrate the cleared Slice 4 role-lane commits into one merge lane so Governor can rerun the verifiers honestly
- Expected Outputs:
  - one integrated Slice 4 package in a clean worktree
- Non-Goals:
  - approving Phase 3
...
- Slice 4 merge lane contains the intended role-lane commits
- worktree is clean
- Governor can rerun the Slice 4 verifiers directly
...
This merge-prep task does not approve Phase 3 and does not close Phase 3.
